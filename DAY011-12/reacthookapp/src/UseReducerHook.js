...
// 여러 컴포넌트에서 해당 리듀서함수의 로직과 프로세스를 재사용하고 싶을 때 유용
import countReducer from "./countReducer";

// 리듀서 함수는 일반적으로 여러 컴퍼넌트에서 공유하기에
// 해당 컴포넌트 위에 정의하거나 별도 모듈파일로 만들어서 참조해서 사용
...
const UseReducerHook = () => {
  ...
  // 디스패치(UI요소에서 해당 리듀서 함수를 실행시켜주는 커맨트역할)와
  // 리듀서 함수(관련 상태값을 CASEBY로 변경하고 로직을 구현) 정의
